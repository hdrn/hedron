...
In order to support loading of multiple wallets in hedron-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hedron.cpp.
...
Changes to hedron.cpp
----------------------
hedron.cpp is the entry point into hedron-qt, and as such, will require some minor modifications to provide hooks for
