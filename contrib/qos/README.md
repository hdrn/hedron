...
This means one can have an always-on hedrond instance running, and another local hedrond/hedron-qt instance which connects to this node and receives blocks from it.
