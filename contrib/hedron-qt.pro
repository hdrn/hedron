...
RESOURCES += src/qt/hedron.qrc src/qt/hedron_locale.qrc

TRANSLATIONS += src/qt/locale/hedron_bg.ts \
                src/qt/locale/hedron_de.ts \
                src/qt/locale/hedron_en.ts \
                src/qt/locale/hedron_es.ts \
                src/qt/locale/hedron_fi.ts \
                src/qt/locale/hedron_fr.ts \
                src/qt/locale/hedron_it.ts \
                src/qt/locale/hedron_ja.ts \
                src/qt/locale/hedron_pl.ts \
                src/qt/locale/hedron_pt.ts \
                src/qt/locale/hedron_ru.ts \
                src/qt/locale/hedron_sk.ts \
                src/qt/locale/hedron_sv.ts \
                src/qt/locale/hedron_vi.ts \
                src/qt/locale/hedron_zh_CN.ts \
                src/qt/locale/hedron_zh_TW.ts
