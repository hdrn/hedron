/* src/config/hedron-config.h.  Generated from hedron-config.h.in by configure.  */
/* src/config/hedron-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Hedron_CONFIG_H

#define Hedron_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.hedron.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Hedron Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Hedron Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "hedron"
