...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Hedron address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hedron: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Hedron"), this);
    aboutAction->setStatusTip(tr("Show information about Hedron"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Hedron"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Hedron addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Hedron addresses"));
    ...
    openAction->setStatusTip(tr("Open a Hedron: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Hedron help message to get a list with possible Hedron command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Hedron client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hedron network", "", count));
}
...
{
    QString strTitle = tr("Hedron"); // default title
