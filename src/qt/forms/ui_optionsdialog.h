...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeHedron = new QSpinBox(tabMain);
        anonymizeHedron->setObjectName(QStringLiteral("anonymizeHedron"));
        anonymizeHedron->setMinimum(100);
        anonymizeHedron->setMaximum(100000);
        anonymizeHedron->setSingleStep(100);
        anonymizeHedron->setValue(1000);

        horizontalLayout->addWidget(anonymizeHedron);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Hedron after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Hedron on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Hedron to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Hedron client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Hedron network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Hedron.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/hedron-project/hedron-project-translations", 0));
