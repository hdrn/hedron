...
/** Utility functions used by the Hedron Qt UI.
 */
namespace GUIUtil
{
...
// Render Hedron addresses in monospace font
...
// Parse "hedron:" URI into recipient object, return true on successful parsing
