...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1522959624, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 25000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "04/04 - Whatever happened on this day!";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1522959624;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 19865;

        hashGenesisBlock = genesis.GetHash();

        //assert(hashGenesisBlock == uint256("0x000002c6acfcc9d4cfb8f0ff38e60979311eec37cdf7ce175f3327bd73b7f30d"));
       //assert(genesis.hashMerkleRoot == uint256("0xf555f4eb2934f29e1f27eb1af88d37e420ebf8888be0ba053fded0ac939e8e68"));

        vSeeds.push_back(CDNSSeedData("45.32.178.138","0.0.0.0"));
        ...
        nStartMasternodePayments = 1522959624;
    }
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet hedron addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet hedron script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet hedron BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet hedron BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet hedron BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Hedron: 1 day
        nTargetSpacing = 1 * 60;        // Hedron: 1 minutes
