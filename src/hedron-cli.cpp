...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Hedron RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  hedron-cli [options] <command> [params]  " + _("Send command to Hedron") + "\n" +
                        "  hedron-cli [options] help                " + _("List commands") + "\n" +
                        "  hedron-cli [options] help <command>      " + _("Get help for a command") + "\n";
