...
#if defined(NDEBUG)
#error "Hedron cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight < 2 && nHeight > 0) {
      nSubsidy = 510000 * COIN;
    } else if (nHeight >= 2 && nHeight < 1440) {
      nSubsidy = 10 * COIN;
    } else if (nHeight >= 1440 && nHeight < 43200) {
      nSubsidy = 200 * COIN;
    } else if (nHeight >= 43200 && nHeight < 86400) {
      nSubsidy = 150 * COIN;
    } else if (nHeight >= 86400 && nHeight < 172800) {
      nSubsidy = 100 * COIN;
    } else if (nHeight >= 172800 && nHeight < 345600) {
      nSubsidy = 75 * COIN;
    } else if (nHeight >= 345600 && nHeight < 791200) {
      nSubsidy = 50 * COIN;
    } else if (nHeight >= 791200) {
      nSubsidy = 25 * COIN;
    }
