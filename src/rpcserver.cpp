...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Hedron features */
        {"hedron", "masternode", &masternode, true, true, false},
        {"hedron", "listmasternodes", &listmasternodes, true, true, false},
        {"hedron", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hedron", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hedron", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hedron", "masternodedebug", &masternodedebug, true, true, false},
        {"hedron", "startmasternode", &startmasternode, true, true, false},
        {"hedron", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hedron", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hedron", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hedron", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hedron", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hedron", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hedron", "mnbudget", &mnbudget, true, true, false},
        {"hedron", "preparebudget", &preparebudget, true, true, false},
        {"hedron", "submitbudget", &submitbudget, true, true, false},
        {"hedron", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hedron", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hedron", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hedron", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hedron", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hedron", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hedron", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hedron", "checkbudgets", &checkbudgets, true, true, false},
        {"hedron", "mnsync", &mnsync, true, true, false},
        {"hedron", "spork", &spork, true, true, false},
        {"hedron", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hedron", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hedrond, or the -server option to hedron-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hedron-cli " + methodname + " " + args + "\n";
}
