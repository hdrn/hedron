...
The Hedron project operates an open contributor model where anyone is
...
The following applies to code changes to the Hedron project, and is not to be
confused with overall Hedron Network Protocol consensus changes.

Whether a pull request is merged into Hedron rests with the project merge
...
Patches that change Hedron consensus rules are considerably more involved than
...
Where a patch set proposes to change the Hedron consensus, it must have been
...
The project leader is the release manager for each Hedron release.
